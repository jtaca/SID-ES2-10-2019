...
--
-- Host: 127.0.0.1
-- Generation Time: 07-Mar-2019 às 18:30
...
GRANT SELECT ON estufa.medicoes_luminosidade TO auditor, investigador;
GRANT SELECT ON estufa.medicoes_temperatura TO auditor,investigador;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `criarRoles` ()  CREATE ROLE investigador, administrador, sensorLuminosidade, sensorTemperatura, auditor, phpUser$$
