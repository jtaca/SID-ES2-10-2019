...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2019 at 03:05 PM
...
--
-- Triggers `medicoesluminosidade`
--
DELIMITER $$
CREATE TRIGGER `insertMedicoesLuminosidade` AFTER INSERT ON `medicoesluminosidade` FOR EACH ROW INSERT into logs VALUES (null, CURRENT_USER, "medicoesLuminosidade", "INSERT", "Não Aplicável", CONCAT("DataHoraMedicao", ": ", new.DataHoraMedicao, "  ValorMedicaoLuminosidade", ": ", new.ValorMedicaoLuminosidade, "  IDMedicao", ": ", new.IDMedicao), NOW(),0)
$$
DELIMITER ;
...
--
DELIMITER $$
CREATE TRIGGER `insertTemperatura` AFTER INSERT ON `medicoestemperatura` FOR EACH ROW INSERT into logs VALUES (null, CURRENT_USER, "medicoesTemperatura", "INSERT", "Não Aplicável", CONCAT("DataHoraMedicao", ": ", new.DataHoraMedicao, "  ValorMedicaoTemperatura", ": ", new.ValorMedicaoTemperatura	, "  IDMedicao", ": ", new.IDMedicao), NOW(),0)
$$
DELIMITER ;
...
--
-- Triggers `variaveismedidas`
--
DELIMITER $$
CREATE TRIGGER `insertVariaveisMedidas` AFTER INSERT ON `variaveismedidas` FOR EACH ROW INSERT into logs VALUES (null, CURRENT_USER, "variaveisMedidas", "INSERT", "Não Aplicável", CONCAT("IDVariavel", ": ", new.IDVariavel, "  IDCultura", ": ", new.IDCultura, "LimiteInferior", ": ", new.LimiteInferior,"LimiteSuperior", ": ", new.LimiteSuperior,"NumeroMedicao\t", ": ", new.NumeroMedicao,"IdVariaveisMedidas\t", ": ", new.IdVariaveisMedidas	 ), NOW(),0)
$$
DELIMITER ;
